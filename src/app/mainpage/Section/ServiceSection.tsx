    ...
    <section className="bg-[#F5D7B7] py-10 px-4 flex flex-col items-center relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {services?.map((service: {
          ...
          <Card key={service.serviceId} className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border-2 border-gray-100">
