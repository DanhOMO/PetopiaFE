    ...
    <div className="max-w-6xl mx-auto py-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        {articles?.map((article) => (
          <Card key={article.articleId} className="flex flex-col rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 border-0 overflow-hidden">
            ...
            <CardFooter className="px-4 pb-4">
              <Link href={`/news/${article.articleId}`} className="w-full">
